...
# one await that never returns is one Marvin that never answers again. A TTS
...
async def run_butler_brain(bus, butler, speaker, turnlog, validate_citations=None,
    ...
    async def _preconnect():
        ...
        # end the task -- Marvin goes deaf until the process restarts, silently,
    ...
    def _safe(fn, *args, **kwargs):
        ...
        # screen while Marvin is still speaking it (tts.done arrives mid-speech).
    ...
    try:
        while True:
            ...
            if etype == "fleet.error":
                ...
                # never starts, and Marvin never mentions it again.
                #
                ...
                if command is not None:
                    ...
                    try:
                        ...
                        if command.verb == "refuse_trade":
                            ...
                            # the awaits: a wedged spawn must not wedge Marvin.
